...
replace (
	...
	github.com/mrunalp/fileutils => github.com/mrunalp/fileutils v0.5.1
	...
	go.etcd.io/etcd => go.etcd.io/etcd v0.5.0-alpha.5.0.20230711085208-c92fb80f3944 // c92fb80f3944 is the SHA for git tag v3.4.27
